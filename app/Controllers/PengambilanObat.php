...
use App\Models\ModelPengambilan;

class PengambilanObat extends BaseController
{
    use ResponseTrait;
    protected $modelName = 'App\Models\ModelPengambilan';
	protected $format = 'json';

    public function __construct()
    {
        $this->model = new ModelPengambilan();
    }
